...
async function rollupBuild(ctx) {
  if (ctx.options.stub) {
    const jitiPath = await (0, _mlly.resolvePath)("jiti", { url: "file:///root/kubeTaskerUI/node_modules/.pnpm/unbuild@1.2.1/node_modules/unbuild/dist/shared/unbuild.f0ca50ec.mjs" });
