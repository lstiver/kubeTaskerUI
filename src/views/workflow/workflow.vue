<template>
  <div class="workflow">
      ...
      <el-col :span="24">
        <div>
          ...
          <el-card
            class="workflow-head-card"
            shadow="never"
            :body-style="{ padding: '30px 10px 20px 10px' }"
          >
              ...
              <el-col :span="3">
                <div>
                  ...
                  <el-button
                    ...
                    icon="Edit"
                    type="primary"
                    @click="createWorkflowDrawerIndex1 = true"
          ...
          >
            ...
            >
              ...
              <el-table-column align="center" min-width="150" label="创建时间">
                <template v-slot="scope">
                  <el-tag type="info"
                    >{{ timeTransNot8(scope.row.created_at) }}
                  </el-tag>
                </template>
              </el-table-column>
              <el-table-column align="center" label="操作" width="200">
                <template v-slot="scope">
                  ...
                  <el-button
                    ...
                    icon="Delete"
                    type="danger"
                    @click="handleConfirm(scope, '删除', delWorkflow)"
                    >删除</el-button
                  >
                </template>
              </el-table-column>
    ...
    <!-- 抽屉弹框1 -->
    <el-drawer
      v-model:value="createWorkflowDrawerIndex1"
      :direction="direction"
    ...
    >
          ...
          <el-col :span="20">
            <el-form label-width="80px">
              <el-form-item
                ...
                prop="name"
              >
                <el-radio v-model:value="createWorkflow.type" label="ClusterIP"
                  >ClusterIP</el-radio
                >
                <el-radio v-model:value="createWorkflow.type" label="NodePort"
                  >NodePort</el-radio
                >
                <el-radio v-model:value="createWorkflow.type" label="Ingress"
                  >Ingress</el-radio
                >
              </el-form-item>
            </el-form>
      ...
      <template #footer>
        <el-button @click="drawerCancel('createWorkflowDrawerIndex1')"
          >取消</el-button
        >
        <el-button type="primary" @click="workflowIndex1Next()"
          >下一步</el-button
        >
      </template>
    </el-drawer>
    <!-- 抽屉弹框2 -->
    <el-drawer
      v-model:value="createWorkflowDrawerIndex2_1"
      :direction="direction"
      :before-close="handleClose"
    >
      <template #title>
          ...
          <el-col :span="20">
            ...
            >
              ...
              <el-form-item
                ...
                prop="name"
              >
                <el-input v-model:value="createWorkflow.name"></el-input>
              </el-form-item>
              <el-form-item
                class="workflow-create-form"
                label="命名空间"
              ...
              >
                <el-select
                  v-model:value="createWorkflow.namespace"
                  filterable
                  placeholder="请选择"
                >
                  <el-option
              ...
              >
                <el-input-number
                  v-model:value="createWorkflow.replicas"
                  :min="1"
                  :max="10"
                ></el-input-number>
                <el-popover
              ...
              <el-form-item
                ...
                prop="image"
              >
                <el-input v-model:value="createWorkflow.image"></el-input>
              </el-form-item>
              <el-form-item
                class="workflow-create-form"
                label="标签"
              ...
              >
                <el-input
                  v-model:value="createWorkflow.label_str"
              ...
              >
                <el-select
                  v-model:value="createWorkflow.resource"
                  placeholder="请选择"
                >
              ...
              >
                <el-input
                  v-model:value="createWorkflow.container_port"
                  placeholder="示例: 80"
                ></el-input>
              </el-form-item>
              <el-form-item
                ...
                prop="health"
              >
                <el-switch v-model:value="createWorkflow.health_check" />
              </el-form-item>
              <el-form-item
                class="workflow-create-form"
                label="检查路径"
              ...
              >
                <el-input
                  v-model:value="createWorkflow.health_path"
      ...
      <template #footer>
        <el-button @click="drawerCancel('createWorkflowDrawerIndex2_1')"
          >取消</el-button
        >
        <el-button
          type="primary"
          @click="submitForm('createWorkflow', workflowIndex2_1Next)"
          >下一步</el-button
        >
      </template>
    </el-drawer>
    <!-- 抽屉弹框3 -->
    <el-drawer
      v-model:value="createWorkflowDrawerIndex2_2"
      :direction="direction"
      :before-close="handleClose"
    >
      <template #title>
        ...
        <el-row type="flex" justify="center">
          <el-col :span="20">
            ...
            >
              ...
              >
                <el-input
                  v-model:value="createWorkflow.port"
                  placeholder="示例: 80"
                ></el-input>
              </el-form-item>
              <el-form-item
                v-if="createWorkflow.type == 'NodePort'"
                class="service-create-form"
                label="NodePort"
                prop="node_port"
              >
                <el-input
                  v-model:value="createWorkflow.node_port"
                  placeholder="示例: 30001"
                ></el-input>
              </el-form-item>
              <el-divider v-if="createWorkflow.type == 'Ingress'"></el-divider>
              <h4
                v-if="createWorkflow.type == 'Ingress'"
              ...
              >
                <el-input
                  v-model:value="createWorkflow.host"
              ...
              >
                <el-input
                  v-model:value="createWorkflow.path"
                  placeholder="示例: /abc"
                ></el-input>
              </el-form-item>
              <el-form-item
              ...
              >
                <el-select
                  v-model:value="createWorkflow.path_type"
                  placeholder="请选择"
                >
      ...
      <template #footer>
        <el-button @click="drawerCancel('createWorkflowDrawerIndex2_2')"
          >取消</el-button
        >
        <el-button
          type="primary"
          @click="submitForm('createWorkflow', createWorkflowFunc)"
          >立即创建</el-button
        >
      </template>
    </el-drawer>
...
export default {
  ...
  methods: {
    ...
    getWorkflows() {
      ...
      httpClient
        .get(this.getWorkflowsData.url, {
          params: this.getWorkflowsData.params,
        })
        .then((res) => {
    ...
    delWorkflow(e) {
      ...
      httpClient
        .delete(this.delWorkflowData.url, { data: this.delWorkflowData.params })
        .then((res) => {
          this.getWorkflows()
