  ...
  <template v-if="getShow">
    ...
    <Form class="p-4 enter-x" :model="formData" :rules="getFormRules" ref="formRef">
      ...
      <FormItem name="account" class="enter-x" :rules="[{ required: true, max: 30 }]">
        <Input class="fix-auto-fill" size="large" v-model:value="formData.account"
      ...
      <FormItem v-if="formData.msgType === 'captcha'" name="email" class="enter-x">
        <Input size="large" v-model:value="formData.email" :placeholder="t('sys.login.email')"
          :rules="[{ required: true, type: 'email' }]" class="fix-auto-fill" />
      </FormItem>
      ...
      <FormItem name="confirmPassword" class="enter-x">
        <InputPassword size="large" visibilityToggle v-model:value="formData.confirmPassword"
      ...
      <!-- <FormItem v-if="formData.msgType === 'captcha'" name="captcha" class="enter-x"
